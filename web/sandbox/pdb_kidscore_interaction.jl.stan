...
generated quantities {
    vector[kid_score_n] kid_score_likelihood = normal_lpdfs(
        kid_score,
        (beta + (beta2 * mom_hs) + (beta3 * mom_iq) + (beta4 * mom_hs * mom_iq)),
        sigma
    );
    vector[kid_score_n] kid_score_gen = normal_vector_rng(
        kid_score_n,
        (beta + (beta2 * mom_hs) + (beta3 * mom_iq) + (beta4 * mom_hs * mom_iq)),
        sigma
    );
