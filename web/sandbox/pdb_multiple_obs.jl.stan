...
generated quantities {
    vector[y1_n] y1_likelihood = normal_lpdfs(y1, mu, sigma1);
    vector[y1_n] y1_gen = normal_vector_rng(y1_n, mu, sigma1);
    vector[y2_n] y2_likelihood = normal_lpdfs(y2, mu, sigma2);
    vector[y2_n] y2_gen = normal_vector_rng(y2_n, mu, sigma2);
}