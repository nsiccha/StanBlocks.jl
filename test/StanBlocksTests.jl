...
function run_test!(name::Symbol; seed=42)
...
function run_tests!(names; seed=42)
    results = Dict{Symbol, Any}()
    for n in names
        results[n] = run_test!(n; seed)
    end
    results
end

function run_all!(; seed=42)
    run_tests!(test_names(); seed)
end
...
function test_slic_normal_loc_scale()
...
function test_slic_srs2_extra_args()
...
function test_slic_stan_model_redata()
...
function test_logdensity_unconstrained_scalar()
...
function test_logdensity_lower_bounded_scalar()
...
function test_logdensity_interval_bounded_scalar()
...
function test_logdensity_unconstrained_vector()
...
function test_logdensity_linear_regression_flat()
...
function test_logdensity_hierarchical()
...
function test_logdensity_dimension_from_data()
...
function test_shapes_vector_creation()
...
function test_shapes_matrix_creation()
...
function test_shapes_conversions()
...
function test_shapes_introspection()
...
function test_shapes_scalar_math()
...
function test_shapes_distributions()
