...
# Motorcycle data case study

Qualitatively reproduces [Aki's motorcycle case study](https://users.aalto.fi/~ave/casestudies/Motorcycle/motorcycle.html#GP_model_with_Hilbert_basis_functions).
