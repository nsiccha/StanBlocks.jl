# Reimplementing the Stan models from `pcr-sensitivity-vs-time`

Source: <https://github.com/bob-carpenter/pcr-sensitivity-vs-time>
...
registration to custom distributions; the legacy compiler inferred those hooks
implicitly.
